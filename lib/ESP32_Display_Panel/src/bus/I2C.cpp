...
/* commented out & replaced with the following, because 'esp_lcd_new_panel_io_i2c()' 
*  envokes the _Generic key word, 
*  which this compiler doesn't seem to recognize.
*/
    ...
    ESP_PANEL_CHECK_ERR_RET(esp_lcd_new_panel_io_i2c_v1((esp_lcd_i2c_bus_handle_t)host_id, &io_config, &handle), false,
                            "Create panel io failed");// Note this calls the legacy I2C driver
